...
--DROP TABLE EVENTS_COMMENTS CASCADE;
...
event_id INTEGER not null
constraint events_comments_event_id_fk REFERENCES EVENTS(event_id) on delete cascade,
comment_id INTEGER not null
constraint events_comments_comment_id_fk REFERENCES COMMENTS(comment_id) on delete cascade
);